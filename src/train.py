    ...
    with tf.variable_scope('', use_resource=True):
        ...
        def _model_fn(i, *args):
                ...
                if params.use_video:
                    ...
                    def body_fn(position, token_x_input, token_y_input, frame_input,
                        ...
                        if params.use_language:
                            ...
                            token_out = mtf.argmax(mtf.reshape(token_out, new_shape=shape),
            ...
            if params.train:
                ...
                update_ops, learning_rate = get_optimizer(loss, params, step)
            else:
                if params.use_language:
        ...
        def tpu_step(i, loss, *values):
            ...
            loss, train_op = _model_fn(i, *values)
        ...
        if params.train:
            ...
            with tf.train.MonitoredTrainingSession(master=cluster_resolver.master(),
                                                   hooks=[ckpt_loader_hook,
                                                          ExamplesPerSecondHook(every_n_steps=10,
                                                                                batch_size=params.train_batch_size * params.grad_accumulation),
            ...
            with tf.train.MonitoredSession(
                    session_creator=tf.train.ChiefSessionCreator(master=cluster_resolver.master(),
