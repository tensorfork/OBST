...
class OptimizerCtx:
    def __init__(self, op: [None, mtf.Operation], grad_outputs: [None, typing.List[mtf.Tensor]],
                 downstream: [None, typing.Set[mtf.Operation]], tensor_to_gradient: [None, dict],
                 tensor_to_var: [None, dict], params: ModelParameter, loss_idx: int, update_ops: list,
                 debug_gradients_dict: [None, dict], loss_list: list, first_grad: [None, dict],
