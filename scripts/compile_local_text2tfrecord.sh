...
machine_options="-march=native -mtune=native -msse2 -msse4.2 -mavx -msse4.1 -msse -msse3 -mstackrealign -mmmx -maes -mpclmul -mclflushopt -mfsgsbase -mrdrnd -mf16c -mpopcnt -mfxsr -mxsave -mxsaveopt -msahf -mcx16 -mmovbe -mshstk -mcrc32 -mmwaitx -mrecip -minline-all-stringops"
